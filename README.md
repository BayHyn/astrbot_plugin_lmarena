...
- Direct_chat模式寻找nano_banana示例：点聊天栏左下角的图片图标，此时就可以页面上方看见模型列表里有nano_banana可选了。
  <img width="1920" height="1080" alt="tmp6C4B" src="https://github.com/user-attachments/assets/1828b52b-b7af-46fd-9ba8-98be3ff86f7c" />
...
- 进入插件配置面板，设置你当前模型的对话模式（direct_chat或battle模）、在 Battle 模式下，要更新的目标（左侧为A，右侧为B），更改后需要重载插件才生效。
